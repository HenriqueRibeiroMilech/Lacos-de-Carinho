using Ldc.Application.UseCases.Expenses.Reports.Pdf.Colors;
...
namespace Ldc.Application.UseCases.Expenses.Reports.Pdf;
...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    private void CreateHeaderWithProfilePhotoAndName(string name, Section page)
    {
        ...
        table.AddColumn("300");
        var row = table.AddRow();
        row.Cells[0].AddImage("C:\\Users\\henri\\images\\logo.png");
    ...
    private void CreateTotalSpentSection(Section page, DateOnly month, decimal totalExpenses)
    {
        ...
        paragraph.AddFormattedText($"Total spent in {month.ToString("Y")}", new Font { Name = FontHelper.RALEWAY_REGULAR, Size = 15});
